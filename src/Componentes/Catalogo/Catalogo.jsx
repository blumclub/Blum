        ...
        <section id="Catalogo" className="bg-secondary py-10 scroll-mt-16 lg:scroll-mt-10 ">
            <div className="mx-auto max-w-2xl md:max-w-4xl lg:max-w-7xl sm:py-4 lg:px-8 md:pt-12">
                ...
                <article className="md:flex md:flex-row md:flex-wrap gap-4 justify-center">
                    {catalogo.map((prod) => {
                        return (
                                <div id="notebook" key={prod.nombre} className="hidden md:flex md:flex-row md:flex-wrap">
                                    <Link href={`/catalogo/${prod.href}`}>
                                        <div className="md:w-60 lg:w-72 xl:w-96 bg-primary rounded-lg shadow">
                                            <div className="group relative cursor-pointer overflow-hidden bg-primary shadow-xl ring-1 ring-gray-900/5 transition-all duration-300 hover:shadow-2xl hover:translate-y-1">
                                                ...
                                                <img className="relative z-10 rounded-t-lg" src="https://res.cloudinary.com/deueso3sr/image/upload/v1726159638/web/uvfwrvc1yihwkkvcf8re.webp" alt="img" />
                    ...
                    {catalogo.map((prod) => {
                        return (
                            <div id="movil" key={prod.nombre} className="md:hidden relative overflow-hidden bg-primary rounded-lg m-2 max-w-7xl my-4">
                                <Link href={`/catalogo/${prod.href}`}>
                                    <div className="group relative cursor-pointer overflow-hidden bg-primary shadow-xl ring-1 ring-gray-900/5 transition-all duration-300 hover:shadow-2xl hovertranslate-y-1">
                                        <span className="absolute top-10 z-0 h-20 w-20 rounded-full bg-gradient-to-r from-[#1a4249] to-[#076885] transition-all duration-300 group-hover:scale-[21]"></span>
                                        <div className="relative grid grid-cols-3 z-10">
                                            <img className="object-cover w-full h-full rounded-tl-lg rounded-bl-lg" src="https://res.cloudinary.com/deueso3sr/image/upload/v1726159638/web/uvfwrvc1yihwkkvcf8re.webp" alt="" />
                                            <div className="col-span-2 p-3 flex flex-col justify-between items-end">
                                                <div>
                                                    ...
                                                    <hr className="mt-1" />
                                                    <p className="text-sm leading-4 pt-3 pb-6 text-gray-200">{prod.descripcion}</p>
                                                </div>
