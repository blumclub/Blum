...
export default function Consultorio() {
  ...
  return (
    <section
      id="consultorio"
      ref={ref}
      className="bg-secondary pb-10 scroll-mt-10 lg:scroll-mt-16"
    >
      <article className="flex flex-col justify-center text-center p-2 mx-auto max-w-7xl">
        <h2 className="text-3xl lg:text-5xl font-aileron text-primary uppercase mt-16 mb-4">
          Consultorio Medico
        </h2>
        <div className="flex flex-col items-center md:flex-row max-w-7xl mx-auto rounded-md p-4">
          <img
            ...
            alt="Medico Tomás León"
            aria-label="Medico Tomás León"
            className="rounded-full w-48 h-48 lg:w-72 md:h-72 lg:h-80 object-cover mb-8 shadow-yellow-400 shadow-xl"
          />
          <div className="px-4 mx-6">
            ...
            <ol className="items-start space-y-4 sm:space-y-0 rtl:space-x-reverse flex flex-col sm:flex-row justify-around md:items-center w-full">
              {steps.map((step, index) => (
                <motion.li
                  key={step.number}
                  className="flex sm:flex-row justify-between text-start items-center text-gray-200 space-x-4 rtl:space-x-reverse"
                ...
                >
                  ...
                  <span className="text-center">
                    <h3 className="font-bold lg:text-xl text-primary">
                      {step.title}
                    </h3>
