    ...
    <section id="consultorio" className="bg-secondary pb-20 scroll-mt-10 lg:scroll-mt-16 " style={{ textAlign: "-webkit-center" }}>
      <article className="flex flex-col justify-center text-center p-2 mx-auto max-w-7xl">
        ...
        <div className="flex flex-col items-center md:flex-row max-w-6xl mx-auto bg-primary rounded-md p-4 bg-opacity-10">
          <img src="https://res.cloudinary.com/deueso3sr/image/upload/v1726241033/10_1_ewahjz.webp" alt="Medico Tomas Leon" aria-label="Medico tomas Leon" width={300}  height={300} className="rounded-lg m-4"/>
          <div className="px-20 ">
