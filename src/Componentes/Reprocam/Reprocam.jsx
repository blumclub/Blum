    ...
    <section className='bg-tertiary' style={{textAlign:'-webkit-center'}}>
      <div className="md:flex bg-tertiary p-4 max-w-[1200px] ">
        ...
        <article className="p-6 bg-primary text-medium text-white rounded-lg w-full min-h-[450px] md:min-h-80 lg:min-h-64">
          {activeTab === 'Tramites' && (
            <div>
              <h2 className="text-lg font-bold text-secondary font-oxanium  mb-2">Tramites relacionados</h2><br/>
                <p>
          ...
          {activeTab === 'Ley' && (
            <div>
              <h2 className="text-lg font-bold text-secondary font-oxanium   mb-2">Marco Legal</h2>
          ...
          {activeTab === 'Reprocam' && (
            <div>
              <h2 className="text-lg font-bold text-secondary font-oxanium  mb-2">Reprocam</h2>
          ...
          {activeTab === 'Consultorio' && (
            <div>
              <h2 className="text-lg font-bold text-secondary font-oxanium  mb-2">Consultorio Medico</h2>
