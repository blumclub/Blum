...
const BtnInstagram = () => {
  return (
    <article className="fixed bottom-24 right-5 z-50">
      <Link href="https://www.instagram.com/blum.club/" target="_blank" rel="noopener noreferrer">
        <button 
          ...
          data-client={true}
        >
          <img src='/redesSociales/insta.svg' alt="Instagram logo" className="w-12 h-12" />
        </button>
      </Link>
    </article>
  );
