    ...
    <section id="nosotros" className="relative z-10 bg-primary"> 
      <article className="p-4 max-w-[780px] mx-auto pb-16 md:pb-24 xl:pb-36 ">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
          ...
          <p className="hidden md:block md:text-9xl place-self-center text-transparent leading-none font-oxanium tracking-wider bg-bgTitle bg-clip-text bg-fixed drop-shadow-secondary font-black rounded-sm bg-left">
            Blüm
          </p>
        </div>
      </article>
      ...
      {/* Curva ondulada SVG */}
      <svg viewBox="0 0 1440 160" fill="none" xmlns="http://www.w3.org/2000/svg" className="absolute bottom-[-1px] sm:bottom-0 lg:bottom-[-4px] left-0 w-full h-auto z-0">
        <path d="M0,64L60,72C120,80,240,96,360,112C480,128,600,144,720,138.7C840,133,960,107,1080,96C1200,85,1320,93,1380,96L1440,100L1440,160L1380,160C1320,160,1200,160,1080,160C960,160,840,160,720,160C600,160,480,160,360,160C240,160,120,160,60,160L0,160Z" fill="#E99006" />
      </svg>
    </section>
  );
}
