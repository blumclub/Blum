    ...
    <section id="nosotros" className="relative z-10 bg-primary"> 
      <article className="p-4 max-w-[780px] mx-auto pb-16 md:pb-24 xl:pb-36 ">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
          ...
          <p className="hidden md:block md:text-9xl place-self-center text-transparent leading-none font-oxanium tracking-wider bg-bgTitle bg-clip-text bg-fixed drop-shadow-secondary font-black rounded-sm">
            Blüm
          </p>
        </div>
      </article>
